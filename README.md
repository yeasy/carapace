...
- **v0.10** (current) — 139 ExecGuard patterns with shell normalization, 75 PathGuard paths, 58 DataExfil patterns, dashboard API auth, SSRF encoding detection, data exfil hardening, 1889 tests
