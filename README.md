<p align="center">
  ...
  <p align="center">
    ...
    <a href="#"><img src="https://img.shields.io/badge/tests-1679%20passed-brightgreen" alt="tests"/></a>
...
```
  ...
  ...99 patterns      ...47 patterns       ...36 patterns
  ...
  ...31 patterns      ...44 patterns       configurable threshold
```
...
mindmap
  root((🛡️ Carapace))
    7 Built-in Rules
      ExecGuard (99 patterns)
      PathGuard (47 patterns)
      NetworkGuard (36 patterns)
      RateLimiter
      PromptInjection (31 patterns)
      DataExfil (44 patterns)
...
npm run test                     # run 1679+ tests across all packages
```
...
- **v0.10** (current) — 99 ExecGuard patterns with shell normalization, 47 PathGuard paths, dashboard API auth, SSRF encoding detection, data exfil hardening, 1679 tests
