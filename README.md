<p align="center">
  ...
  <p align="center">
    ...
    <a href="#"><img src="https://img.shields.io/badge/tests-1889%20passed-brightgreen" alt="tests"/></a>
...
```
  ...
  ...138 patterns      ...73 patterns       ...38 patterns
...
npm run test                     # run 1889 tests across all packages
```
...
- **v0.10** (current) — 138 ExecGuard patterns with shell normalization, 73 PathGuard paths, 57 DataExfil patterns, dashboard API auth, SSRF encoding detection, data exfil hardening, 1889 tests
