...
```
  ...
  ...152 patterns      ...73 patterns       ...43 patterns
  ...
  ...43 patterns      ...65 patterns       configurable threshold
```
...
npm run test                     # run 2032 tests across all packages
```
