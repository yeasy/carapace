<p align="center">
  ...
  <p align="center">
    ...
    <a href="#"><img src="https://img.shields.io/badge/tests-1968%20passed-brightgreen" alt="tests"/></a>
...
```
  ...
  ...142 patterns      ...73 patterns       ...41 patterns
  ...
  ...37 patterns      ...60 patterns       configurable threshold
```
...
mindmap
  root((🛡️ Carapace))
    7 Built-in Rules
      ExecGuard (142 patterns)
      PathGuard (73 patterns)
      NetworkGuard (41 patterns)
      RateLimiter
      PromptInjection (37 patterns)
      DataExfil (60 patterns)
...
npm run test                     # run 1968 tests across all packages
```
...
- **v0.11** (current) — 142 ExecGuard patterns with shell normalization, 73 PathGuard paths, 41 NetworkGuard patterns, 37 PromptInjection patterns, 60 DataExfil patterns, container escape & supply chain detection, env -S / IPv6-mapped / file:// bypass fixes, 1968 tests
