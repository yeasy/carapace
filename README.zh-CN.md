...
- **v0.11**（当前）— 142 条 ExecGuard 模式（含 shell 归一化）、73 条 PathGuard 路径、41 条 NetworkGuard 模式、37 条 PromptInjection 模式、60 条 DataExfil 模式、容器逃逸与供应链检测、env -S / IPv6-mapped / file:// 绕过修复、1968 个测试
