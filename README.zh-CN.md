...
- **v0.10**（当前）— 139 条 ExecGuard 模式（含 shell 归一化）、75 条 PathGuard 路径、42 条 NetworkGuard 模式、58 条 DataExfil 模式、Dashboard API 认证、SSRF 编码检测、数据外泄加固、1923 个测试
