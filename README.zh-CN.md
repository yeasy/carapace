...
- **v0.2**（当前）— 频率限制规则、ESLint + CI 流水线、正则校验加固、错误日志改进
- **v0.3** — MCP 协议代理适配器、逐 Skill 行为基线、数据外泄检测
- **v0.4** — LangChain / CrewAI 适配器（Python bridge）、YAML 自定义规则
