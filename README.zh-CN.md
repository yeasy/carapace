...
- **v0.10**（当前）— 122 条 ExecGuard 模式（含 shell 归一化）、72 条 PathGuard 路径、58 条 DataExfil 模式、Dashboard API 认证、SSRF 编码检测、数据外泄加固、1806 个测试
