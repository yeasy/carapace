...
- **v0.12**（当前）— 152 条 ExecGuard、73 条 PathGuard、43 条 NetworkGuard、43 条 PromptInjection、65 条 DataExfil 模式、git config hook 检测、alias/function 规避检测、URL 缩短服务检测、awk 变体检测（gawk/mawk/nawk）、adapter-langchain 响应扫描、INVISIBLE_CHARS_RE 与 extractStringContent 整合、2038 个测试
